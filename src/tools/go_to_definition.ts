...
export const go_to_definition: ToolDef<GoToDefinitionArgs, GoToDefinitionResult> = {
    id: "go_to_definition",
    ...
    async run({ textDocument, position }: GoToDefinitionArgs) {
        ...
        const definition = await vscode.commands.executeCommand<vscode.LocationLink[]>(
