...
export const get_workspace_symbols: ToolDef<
  GetWorkspaceSymbolsArgs,
  GetWorkspaceSymbolsResult
> = {
  ...
  schema: z.object({
    query: z
      .string()
      .describe(
        "The search query to match against symbol names. Can be partial and is case-insensitive."
      ),
  }),
