...
type GetTypeDefinitionResult = (z.infer<typeof locationSchema> | z.infer<typeof locationLinkSchema>)[];

export const get_type_definition: ToolDef<GetTypeDefinitionArgs, GetTypeDefinitionResult> = {
    id: "get_type_definition",
