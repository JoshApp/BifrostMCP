...
export const get_selection_range: ToolDef<GetSelectionRangeArgs, GetSelectionRangeResult> = {
    id: "get_selection_range",
    description: "Gets selection ranges for a position in a document for smart, structure-aware expansions.",
    schema: z.object({
