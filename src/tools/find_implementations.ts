...
export const find_implementations: ToolDef<
  FindImplementationsArgs,
  FindImplementationsResult
> = {
  name: "find_implementations",
  description:
    "Discovers all concrete implementations of an interface, abstract class, or abstract method in the codebase.",
  schema: z.object({
