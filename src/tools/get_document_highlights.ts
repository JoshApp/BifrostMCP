...
import { textDocumentSchema, positionSchema, rangeSchema } from "../types/tools";
...
export const get_document_highlights: ToolDef<GetDocumentHighlightsArgs, GetDocumentHighlightsResult> = {
    id: "get_document_highlights",
